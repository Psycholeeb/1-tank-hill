...
import static vlad.stupak.BikeRacing.media;
...
public class Intro extends StageGame{
    ...
    public Intro() {
        ...
        title = new Image(BikeRacing.atlas.findRegion("title"));
        addChild(title);
        ...
        playBtn = new ImageButton(
                new TextureRegionDrawable(BikeRacing.atlas.findRegion("play_btn")),
                new TextureRegionDrawable(BikeRacing.atlas.findRegion("play_btn_down"))
        );
