...
public class LevelList  extends StageGame {
    ...
    public LevelList() {
        Image bg = new Image(BikeRacing.atlas.findRegion("intro_bg"));
        ...
        int progress = BikeRacing.data.getProgress();
        ...
        ImageButton rateBtn = new ImageButton(new TextureRegionDrawable(BikeRacing.atlas.findRegion("rate")),
                new TextureRegionDrawable(BikeRacing.atlas.findRegion("rate_down")));
        ...
        ImageButton shareBtn = new ImageButton(new TextureRegionDrawable(BikeRacing.atlas.findRegion("share")),
                new TextureRegionDrawable(BikeRacing.atlas.findRegion("share_down")));
        addChild(shareBtn);
    ...
    private ClickListener iconlistener = new ClickListener() {
        ...
        public void clicked(InputEvent event, float x, float y) {
            ...
            BikeRacing.media.playSound("click.ogg");
